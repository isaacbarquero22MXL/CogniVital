...
const NervousSystem = () => {
  useEffect(() => {
    let canvas = document.querySelector("#brain-canvas");
  ...
  return  <canvas id="brain-canvas" className="inline-block	absolute top-[50%] left-[50%] translate-y-[-50%] translate-x-[-50%] max-w-[100%] max-h-[100%]"></canvas>;
};
